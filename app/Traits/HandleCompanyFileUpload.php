...
trait HandleCompanyFileUpload
{
    public function handleCompanyLogoUpload(string $fieldName, string $uploadSubDir = "company/")
    {
        if (isset($_FILES[$fieldName]) && $_FILES[$fieldName]['error'] === UPLOAD_ERR_OK) {
            ...
            if (move_uploaded_file($tmpName, $targetFile)) {
                ...
                return $_SESSION['error'] = "Failed to upload company logo.";
            }
        } else {
            return ['path' => null];
        }
