...
trait HandlePortfolioFileUpload
{
    public function handlePortfolioImageUpload(string $fieldName, string $uploadSubDir = "portfolio/")
    {
        if (isset($_FILES[$fieldName]) && $_FILES[$fieldName]['error'] === UPLOAD_ERR_OK) {
            ...
            if (move_uploaded_file($tmpName, $targetFile)) {
                ...
                return $_SESSION['error'] = "Failed to upload portfolio image.";
            }
        } else {
            return ['path' => null];
        }
