      ...
      <div class="col-12 col-lg-6 bg-white shadow p-3">
        <div class="form w-100 pb-2">
          ...
          <form method="POST" action="/" class="row">
            ...
            <div class="col-lg-6 col-md mb-3">
              <input type="text" placeholder="Phone" name="phone" id="inputPhone" class="shadow form-control form-control-lg">
            </div>
            <div class="col-lg-12 mb-3">
              <input type="email" placeholder="email address" name="email" id="inputEmail" class="shadow form-control form-control-lg">
            </div>
            <div class="col-lg-12 mb-3">
              <textarea placeholder="message" name="message" id="message" rows="8" class="shadow form-control form-control-lg"></textarea>
            </div>
